package com.amusexd.guessthecelebrity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result = null;
        Log.i("Print", "Request content progressing");
        try {
    ...
    public void createNewQuestion() {
        ...
        try {
            celebImage = imageTask.execute(celebsURLs.get(chosenCeleb)).get();
    ...
    public void celebChosen(View view) {
        if (view.getTag().toString().equals(Integer.toString(locationOfCorrectAnswer))) {
            ...
            Toast.makeText(getApplicationContext(), "Wrong! it was " + celebsNames.get(chosenCeleb), Toast.LENGTH_LONG).show();
        }
